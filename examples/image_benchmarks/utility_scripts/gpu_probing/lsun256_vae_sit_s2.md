# Batch-size selection — lsun_church @256 / VAE / SiT-S/2

Dataset: `lsun_church` · Architecture: SiT-S/2 @256
Tool: `probe_ngd_memory.py` (NGD worst-case path, `--warmup 8 --measure 20`, `PREALLOCATE=false`, arena 0.75)
Raw results: `lsun256_vae_sit_s2_gpu2_results/`, `lsun256_vae_sit_s2_gpu4_results/`

## 2 GPUs (global batch sharded over 2 device(s))

| batch size | ms/step | ms/image | peak mem (GiB) | frac | steady |
|---:|---:|---:|---:|---:|---:|
| 32 **| 5847 **| 182.71 **| 19.1 **| 0.48 **| False **|
| 64 | 11261 | 175.96 | 31.7 | 0.79 | False |
| 128 | 22133 | 172.91 | 31.7 | 0.79 | False |
| 256 | OOM | OOM | OOM | — | — |
| 512 | OOM | OOM | OOM | — | — |
| 1024 | OOM | OOM | OOM | — | — |
...
| batch size | ms/step | ms/image | peak mem (GiB) | frac | steady |
|---:|---:|---:|---:|---:|---:|
| 32 | 3146 | 98.30 | 11.1 | 0.28 | False |
| 64 **| 5876 **| 91.81 **| 19.1 **| 0.48 **| False **|
| 128 | 11291 | 88.21 | 31.7 | 0.79 | False |
| 256 | 22159 | 86.56 | 31.7 | 0.79 | False |
| 512 | OOM | OOM | OOM | — | — |
| 1024 | OOM | OOM | OOM | — | — |
